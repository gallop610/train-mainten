...
from utils.utils_time import convert_day_to_quarter, convert_day_to_month
...
def output_wholeLife_plan(workpackage):
    ...
    for i in range(len(workpackage)):
        ...
        for j in range(len(work.mainten_quarter)):
            ...
            mainten_quarter.append((work.Train_Number,work.Work_Package_Number, work.Work_Package_Person_Day, int(work.Work_Package_Interval_Conversion_Value), work.Cooling_Time,date,last_mainten))
...
def output_year_plan(workpackage):
    ...
    for i in range(len(workpackage)):
        ...
        for j in range(len(work.mainten_month)):
            ...
            mainten_month.append((work.Train_Number,work.Work_Package_Number, work.Work_Package_Person_Day, int(work.Work_Package_Interval_Conversion_Value), work.Cooling_Time,date,last_mainten))
